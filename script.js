     ...
     .then((movies) => {
         ...
         justify-center">`;
             movies.forEach(movies =>{
              html += ` 
              <li
                 class="bg-black/25 basis-1/4 text-white-900 p-2 rounded-md
                  flex flex-col justify-between">
                 <h3>
  <span class="block">Titel: ${movies.movieTitle}</span>
  <span class="block">Längd: ${movies.runTime} min</span>
  <span class="block">Utgiven: ${movies.movieYear}</span>
</h3>
